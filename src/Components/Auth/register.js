    ...
    return (
        <div className='auth'>
            <div className='auth__container'>
                ...
                <input type="password" name="confirm_password" id="confirm_password" className="input w-full mb-4" placeholder="Confirma parola..." />
                <button className="button mt-3 mx-auto">Înregistrează-te</button>
